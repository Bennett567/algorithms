...
let poo = 0, por = 0, poh = 0, pto = 0, ptr = 0, pth = 0;
let answer
let answer2
let pooc = 0, porc = 0, pohc = 0, ptoc = 0, ptrc = 0, pthc = 0;
let p1inv = false
let p2inv = false
...
function findgood(movep1, movep2) {
  if(matrixc == []){
    matrixc = [new Array(5), new Array(5), new Array(5), new Array(5), new Array(5)]
    for (var i = 0; i < 5; i++) {
      for (var j = 0; j < 5; j++) {
